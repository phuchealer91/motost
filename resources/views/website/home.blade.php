    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="entry2">
                    <a href="{{ route('website.post', ['slug' => $post->slug]) }}"><img src="{{ asset($post->image) }}"
                    ...
                    <div class="excerpt">
                       ...
                       <!-- <p> {{strip_tags(Str::limit($post->description,100))}}</p>
                        <p><a href="{{ route('website.post', ['slug' => $post->slug]) }}">Xem thêm</a></p> -->
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-7">
                ...
                <div class="two-col d-block d-md-flex justify-content-between">
                    ...
                    <a href="{{ route('website.post', ['slug' => $post->slug]) }}"
                        class="hentry v-height img-2 gradient" style="background-image: url('{{ asset($post->image) }}');">
