...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Danh sách thẻ (tag)</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('tag.create') }}" class="btn btn-primary">Thêm mới thẻ (tag)</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr>
                                        <td colspan="4">
                                            <h5 class="text-center">Không có dữ liệu thẻ (tag)</h5>
                                        </td>
                                    </tr>
