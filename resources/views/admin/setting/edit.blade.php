        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Cập nhật cài đặt</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Cập nhật cài đặt </h3>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('setting.update') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="name">Tên web</label>
                                            <input type="name" name="name" value="{{ $setting->name }}" class="form-control" placeholder="Điền tên">
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="description">Miêu tả web</label>
                                            <textarea name="description" id="description" rows="3" class="form-control" placeholder="Điền miêu tả">{{ $setting->description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-lg btn-primary">Cật nhật</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
