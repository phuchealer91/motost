...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Thông tin thành viên</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="password">Mật khẩu<small class="text-info"> (Nhập mật khẩu bạn muốn thay đổi.)</small></label>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" rows="5" class="form-control" placeholder="Viết giới thiệu về bạn">{{ $user->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
