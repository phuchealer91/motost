        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('post.index') }}">Danh sách tin tức</a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Cập nhật tin tức - {{ $post->name }}</h3>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('post.update', [$post->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="name" name="title" value="{{ $post->title }}" class="form-control" placeholder="Điền tiêu đề">
                                        </div>
                                        <div class="form-group">
                                            <label for="category">Danh mục</label>

                                            <select name="category" id="category" class="form-control">
                                                <option value="" style="display: none" selected>Chọn danh mục</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" rows="4" class="form-control"
                                                placeholder="Điền miêu tả">{{ $post->description }}</textarea>
                                        </div>
                                        <div class="form-group">
