        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 search-form-wrap js-search-form">
            <form method="get" action="{{url('/search')}}">
              <input type="search" name="query" id="s" class="form-control" placeholder="Tìm kiếm...">
              <button class="search-btn" type="submit"><span class="icon-search"></span></button>
            </form>
          </div>

          <div class="col-4 site-logo">
            <a href="/" class="text-black h2 mb-0">Motost</a>
          </div>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled float-left mr-5">
              ...
              <li><a href="{{ route('website.about') }}">Giới thiệu</a></li>
              <li><a href="{{ route('website.contact') }}">Liên hệ</a></li>
            </ul>
          ...
          <div class="col-md-4">
            <div>
              <h3 class="footer-heading mb-4">Kết nối với chúng tôi</h3>
              <p>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              {{ $setting->copyright }} | Nguyen IT  <i class="icon-heart text-danger" aria-hidden="true"></i>
              </p>
          </div>
        </div>
      </div>
